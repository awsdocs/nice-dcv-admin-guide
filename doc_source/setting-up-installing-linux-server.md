...
1. Download the packages from the [NICE website](http://download.nice-dcv.com)\. The RPM and deb packages are packaged into a `.tgz` archive\. Make sure that you download the correct archive for your operating system\.
   ...
   + 64\-bit ARM
     ...
     ```
     $ wget https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-el7-aarch64.tgz
     ```
...
1. Extract the contents of the `.tgz` archive and navigate into the extracted directory\.
   ...
   + 64\-bit ARM
     ...
     ```
     $ tar -xvzf nice-dcv-2021.2-11048-el7-aarch64.tgz && cd nice-dcv-2021.2-11048-el7-aarch64
     ```
...
1. Install the NICE DCV server\.
   ...
   + 64\-bit ARM
     ...
     ```
     $ sudo yum install nice-dcv-server-2021.2.11048-1.el7.aarch64.rpm
     ```
...
1. \(Optional\) To use the web client with NICE DCV version 2021\.2 and later, install the `nice-dcv-web-viewer` package\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-web-viewer-2021.2.11048-1.el7.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-dcv-web-viewer-2021.2.11048-1.el7.aarch64.rpm
     ```
...
1. \(Optional\) To use virtual sessions, install the `nice-xdcv` package\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-xdcv-2021.2.406.el7.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-xdcv-2021.2.406.el7.aarch64.rpm
     ```
...
1. \(Optional\) If you plan to use GPU sharing, install the `nice-dcv-gl` package\. 
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-gl-2021.2.944.el7.x86_64.rpm
     ```
**Note**  
...
1. \(Optional\) If you plan to use NICE DCV with NICE EnginFrame, install the `nice-dcv-simple-external-authenticator` package\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-simple-external-authenticator-2021.2.160.el7.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-dcv-simple-external-authenticator-2021.2.160.el7.aarch64.rpm
     ```
...
1. Download the packages from the [NICE website](http://download.nice-dcv.com)\. The RPM and deb packages are packaged into a `.tgz` archive\. Ensure that you download the correct archive for your operating system\.
   + 64\-bit x86
     ...
     ```
     $ wget https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-el8-x86_64.tgz
     ```
   + 64\-bit ARM

     ```
     $ wget https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-el8-aarch64.tgz
     ```
...
1. Extract the contents of the `.tgz` archive and navigate into the extracted directory\.
   + 64\-bit x86
     ...
     ```
     $ tar -xvzf nice-dcv-2021.2-11048-el8-x86_64.tgz && cd nice-dcv-2021.2-11048-el8-x86_64
     ```
   + 64\-bit ARM

     ```
     $ tar -xvzf nice-dcv-2021.2-11048-el8-aarch64.tgz && cd nice-dcv-2021.2-11048-el8-aarch64
     ```
...
1. Install the NICE DCV server\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-server-2021.2.11048-1.el8.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-dcv-server-2021.2.11048-1.el8.aarch64.rpm
     ```
...
1. \(Optional\) If you plan to use the web client with NICE DCV version 2021\.2 and later, install the `nice-dcv-web-viewer` package\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-web-viewer-2021.2.11048-1.el8.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-dcv-web-server-2021.2.11048-1.el8.aarch64.rpm
     ```
...
1. \(Optional\) To use virtual sessions, install the `nice-xdcv` package\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-xdcv-2021.2.406.el8.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-xdcv-2021.2.406.el8.aarch64.rpm
     ```
...
1. \(Optional\) If you plan to use GPU sharing, install the `nice-dcv-gl` package\. 
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-gl-2021.2.944.el8.x86_64.rpm
     ```
**Note**  
You can optionally install the `nice-dcv-gltest` package\. This package includes a simple OpenGL application that can be used to determine if your virtual sessions are properly configured to use hardware\-based OpenGL\.
...
1. \(Optional\) If you plan to use NICE DCV with NICE EnginFrame, install the `nice-dcv-simple-external-authenticator` package\.
   + 64\-bit x86
     ...
     ```
     $ sudo yum install nice-dcv-simple-external-authenticator-2021.2.160.el8.x86_64.rpm
     ```
   + 64\-bit ARM

     ```
     $ sudo yum install nice-dcv-simple-external-authenticator-2021.2.160.el8.aarch64.rpm
     ```
...
1. Download the packages from the [NICE website](http://download.nice-dcv.com)\. The RPM and deb packages are packaged into a `.tgz` archive\. Ensure that you download the correct archive for your operating system\.
   + SLES 12\.x
     ...
     ```
     $ curl -O https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-sles12-x86_64.tgz
     ```
   + SLES 15\.x

     ```
     $ curl -O https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-sles15-x86_64.tgz
     ```
...
1. Extract the contents of the `.tgz` archive and navigate into the extracted directory\.
   + SLES 12\.x
     ...
     ```
     $ tar -xvzf nice-dcv-2021.2-11048-sles12-x86_64.tgz && cd nice-dcv-2021.2-11048-sles12-x86_64
     ```
   + SLES 15\.x

     ```
     $ tar -xvzf nice-dcv-2021.2-11048-sles15-x86_64.tgz && cd nice-dcv-2021.2-11048-sles15-x86_64
     ```
...
1. Install the NICE DCV server\.
   + SLES 12\.x
     ...
     ```
     $ sudo zypper install nice-dcv-server-2021.2.11048-1.sles12.x86_64.rpm
     ```
   + SLES 15\.x

     ```
     $ sudo zypper install nice-dcv-server-2021.2.11048-1.sles15.x86_64.rpm
     ```
...
1. \(Optional\) If you plan to use the web client with NICE DCV version 2021\.2 and later, install the `nice-dcv-web-viewer` package\.
   + SLES 12\.x
     ...
     ```
     $ sudo zypper install nice-dcv-web-viewer-2021.2.11048-1.sles12.x86_64.rpm
     ```
   + SLES 15\.x

     ```
     $ sudo zypper install nice-dcv-web-viewer-2021.2.11048-1..sles15.x86_64.rpm
     ```
...
1. \(Optional\) To use virtual sessions, install the `nice-xdcv` package\.
   + SLES 12\.x
     ...
     ```
     $ sudo zypper install nice-xdcv-2021.2.406.sles12.x86_64.rpm
     ```
   + SLES 15\.x

     ```
     $ sudo zypper install nice-xdcv-2021.2.406.sles15.x86_64.rpm
     ```
...
1. \(Optional\) If you plan to use GPU sharing, install the `nice-dcv-gl` package\. 
   + SLES 12\.x
     ...
     ```
     $ sudo zypper install nice-dcv-gl-2021.2.944.sles12.x86_64.rpm
     ```
   + SLES 15\.x

     ```
     $ sudo zypper install nice-dcv-gl-2021.2.944.sles15.x86_64.rpm
     ```
**Note**  
...
1. \(Optional\) If you plan to use NICE DCV with NICE EnginFrame, install the `nice-dcv-simple-external-authenticator` package\. 
   + SLES 12\.x
     ...
     ```
     $ sudo zypper install nice-dcv-simple-external-authenticator-2021.2.160.sles12.x86_64.rpm
     ```
   + SLES 15\.x

     ```
     $ sudo zypper install nice-dcv-simple-external-authenticator-2021.2.160.sles15.x86_64.rpm
     ```
...
1. Download the packages from the [NICE website](http://download.nice-dcv.com)\. The RPM and deb packages are packaged into a `.tgz` archive\. Ensure that you download the correct archive for your operating system\.
   ...
   + Ubuntu 18\.04 \(64\-bit ARM\)
     ...
     ```
     $ wget https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-ubuntu1804-aarch64.tgz
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ wget https://d1uj6qtbmh3dt5.cloudfront.net/2021.2/Servers/nice-dcv-2021.2-11048-ubuntu2004-x86_64.tgz
     ```
...
1. Extract the contents of the `.tgz` archive and navigate into the extracted directory\.
   + Ubuntu 18\.04 \(64\-bit x86\)
     ...
     ```
     $ tar -xvzf nice-dcv-2021.2-11048-ubuntu1804-x86_64.tgz && cd nice-dcv-2021.2-11048-ubuntu1804-x86_64
     ```
   + Ubuntu 18\.04 \(64\-bit ARM\)

     ```
     $ tar -xvzf nice-dcv-2021.2-11048-ubuntu1804-arm64.tgz && cd nice-dcv-2021.2-11048-ubuntu1804-arm64
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ tar -xvzf nice-dcv-2021.2-11048-ubuntu2004-x86_64.tgz && cd nice-dcv-2021.2-11048-ubuntu2004-x86_64
     ```
...
1. Install the NICE DCV server\.
   + Ubuntu 18\.04 \(64\-bit x86\)
     ...
     ```
     $ sudo apt install ./nice-dcv-server_2021.2.11048-1_amd64.ubuntu1804.deb
     ```
   + Ubuntu 18\.04 \(64\-bit ARM\)

     ```
     $ sudo apt install ./nice-dcv-server_2021.2.11048-1_arm64.ubuntu1804.deb
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ sudo apt install ./nice-dcv-server_2021.2.11048-1_amd64.ubuntu2004.deb
     ```
...
1. \(Optional\) If you plan to use the web client with NICE DCV version 2021\.2 and later, install the `nice-dcv-web-viewer` package\.
   + Ubuntu 18\.04 \(64\-bit x86\)
     ...
     ```
     $ sudo apt install ./nice-dcv-web-viewer_2021.2.11048-1_amd64.ubuntu1804.deb
     ```
   + Ubuntu 18\.04 \(64\-bit ARM\)

     ```
     $ sudo apt install ./nice-dcv-web-viewer_2021.2.11048-1_arm64.ubuntu1804.deb
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ sudo apt install ./nice-dcv-web-viewer_2021.2.11048-1_amd64.ubuntu2004.deb
     ```
...
1. \(Optional\) If you plan to use virtual sessions, install the `nice-xdcv` package\.
   + Ubuntu 18\.04 \(64\-bit x86\)
     ...
     ```
     $ sudo apt install ./nice-xdcv_2021.2.406_amd64.ubuntu1804.deb
     ```
   + Ubuntu 18\.04 \(64\-bit ARM\)

     ```
     $ sudo apt install ./nice-xdcv_2021.2.406_arm64.ubuntu1804.deb
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ sudo apt install ./nice-xdcv_2021.2.406_amd64.ubuntu2004.deb
     ```
...
1. \(Optional\) If you plan to use GPU sharing, install the `nice-dcv-gl` package\. 
   + Ubuntu 18\.04 \(64\-bit x86\)
     ...
     ```
     $ sudo apt install ./nice-dcv-gl_2021.2.944_amd64.ubuntu1804.deb
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ sudo apt install ./nice-dcv-gl_2021.2.944_amd64.ubuntu2004.deb
     ```
**Note**  
You can optionally install the `nice-dcv-gltest` package\. This package includes a simple OpenGL application that can be used to determine if your virtual sessions are properly configured to use hardware\-based OpenGL\.
...
1. \(Optional\) If you plan to use NICE DCV with NICE EnginFrame, install the `nice-dcv-simple-external-authenticator` package\. 
   + Ubuntu 18\.04 \(64\-bit x86\)
     ...
     ```
     $ sudo apt install ./nice-dcv-simple-external-authenticator_2021.2.160_amd64.ubuntu1804.deb
     ```
   + Ubuntu 18\.04 \(64\-bit ARM\)

     ```
     $ sudo apt install ./nice-dcv-simple-external-authenticator_2021.2.160_arm64.ubuntu1804.deb
     ```
   + Ubuntu 20\.04 \(64\-bit x86\)

     ```
     $ sudo apt install ./nice-dcv-simple-external-authenticator_2021.2.160_amd64.ubuntu2004.deb
     ```
